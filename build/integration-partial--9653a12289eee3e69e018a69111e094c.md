...
```{exercise}
:label: integration-partial-fractions-sb-1
$\displaystyle \int \frac{2x+16}{x^2-16} \d{x}$
```

```{solution} integration-partial-fractions-sb-1
:class: dropdown
...
```{exercise}
:label: integration-partial-fractions-sb-2
$\displaystyle \int \frac{8}{x^2+2x} \d{x}$
```

```{solution} integration-partial-fractions-sb-2
:class: dropdown
Fractional decomposition:
...
```{exercise}
:label: integration-partial-fractions-sb-3
$\displaystyle \int \frac{5+12x^2-x^3}{x^2(x-9)(x-1)} \d{x}$
```

```{solution} integration-partial-fractions-sb-3
:class: dropdown
Fractional decomposition
