...
```{exercise}
:label: total-differential-sb-1
$\displaystyle\td{}{f}{x}{y}$
```

```{solution} total-differential-sb-1
:class: dropdown
...
```{exercise}
:label: total-differential-sb-2
$\displaystyle\td{}{f}{y}{x}$
```

```{solution} total-differential-sb-2
:class: dropdown
Based on differential:
\begin{equation}
...
```{exercise}
:label: total-differential-sb-3
$\displaystyle\td{2}{f}{x}{y}$
```

```{solution} total-differential-sb-3
:class: dropdown
\begin{align}
...
```{exercise}
:label: total-differential-sb-4
$\displaystyle\td{2}{f}{y}{x}$
```

```{solution} total-differential-sb-4
:class: dropdown
\begin{align}
...
```{exercise}
:label: total-differential-sb-5
$\displaystyle\frac{\partial^2 f}{\partial x \partial y}$
```

```{solution} total-differential-sb-5
:class: dropdown
\begin{align}
...
```{exercise}
:label: total-differential-sb-6
$\displaystyle\frac{\partial^2 f}{\partial y \partial x}$
```

```{solution} total-differential-sb-6
:class: dropdown
\begin{align}
...
```{exercise}
:label: total-differential-sb-7
$\displaystyle\td{}{f}{t}{u}$
```

```{solution} total-differential-sb-7
:class: dropdown
\begin{align}
...
```{exercise}
:label: total-differential-sb-8
$\displaystyle\td{}{f}{u}{t}$
```

```{solution} total-differential-sb-8
:class: dropdown
\begin{align}
