...
```{exercise}
:label: systems-first-order-odes-homogeneous-constant-coefficient-sb-1
...
```{solution} systems-first-order-odes-homogeneous-constant-coefficient-sb-1
:class: dropdown
...
```{exercise}
:label: systems-first-order-odes-homogeneous-constant-coefficient-sb-2
...
```{solution} systems-first-order-odes-homogeneous-constant-coefficient-sb-2
:class: dropdown
...
```{exercise}
:label: systems-first-order-odes-homogeneous-constant-coefficient-sb-3
...
```{solution} systems-first-order-odes-homogeneous-constant-coefficient-sb-3
:class: dropdown
First, find the eigenvalues of **A**:
...
```{exercise}
:label: systems-first-order-odes-homogeneous-constant-coefficient-sb-4
...
```{solution} systems-first-order-odes-homogeneous-constant-coefficient-sb-4
:class: dropdown
First, find the eigenvalues of **A**
