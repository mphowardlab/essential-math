...
```{exercise}
:label: eigenvalue-problem-sb-1
\begin{equation}
\vv{A} = \begin{bmatrix} 4 & 2 \\ 0 & -4 \end{bmatrix}
\end{equation}
```

```{solution} eigenvalue-problem-sb-1
:class: dropdown
...
```{solution} eigenvalue-problem-sb-2
:class: dropdown
...
```{solution} eigenvalue-problem-sb-3
:class: dropdown
First, find the eigenvalues:
