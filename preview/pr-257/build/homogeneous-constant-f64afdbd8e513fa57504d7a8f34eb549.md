...
```{exercise}
:label: second-order-odes-homogeneous-constant-coefficient-sb-1
$y'' - 2y' - 3y = 0$, $y(0) = 2$, $y'(0) = 14$
```

```{solution} second-order-odes-homogeneous-constant-coefficient-sb-1
:class: dropdown
Write and solve the characteristic polynomial:
...
```{exercise}
:label: second-order-odes-homogeneous-constant-coefficient-sb-2
$y'' + 2y' + y = 0$, $y(0) = 4$, $y'(0) = -6$
```

```{solution} second-order-odes-homogeneous-constant-coefficient-sb-2
:class: dropdown
Write and solve the characteristic polynomial:
...
```{exercise}
:label: second-order-odes-homogeneous-constant-coefficient-sb-3
$10y'' - 50y' + 65y = 0$, $y(0) = \frac{3}{2}$, $y'(0) = \frac{3}{2}$
```

```{solution} second-order-odes-homogeneous-constant-coefficient-sb-3
:class: dropdown
Write and solve the characteristic polynomial:
...
```{exercise}
:label: second-order-odes-homogeneous-constant-coefficient-sb-4
$y'' + \pi y' = 0$, $y(0) = 3$, $y'(0) = -\pi$
```

```{solution} second-order-odes-homogeneous-constant-coefficient-sb-4
:class: dropdown
Write and solve the characteristic polynomial:
