...
Its usually a good idea to expand along the row or column with the most zeros! For the 4 by 4 matrix *i*=4 i.e. row ``` 0 2 0 0 ``` { - + - + } and for the 3 by 3 matrix j=3 i.e. column  ```0 0 5``` { + - + }
