...
```{exercise}
:label: laplace-transform-sb-1
$y' + 4y = e^{4x}$, $y(0) = 0$
```

```{solution} laplace-transform-sb-1
:class: dropdown
...
```{exercise}
:label: laplace-transform-sb-2
$y' + 2y = 8$, $y(0) = 1$
```

```{solution} laplace-transform-sb-2
:class: dropdown
...
```{exercise}
:label: laplace-transform-sb-3
$y' - y = 1 - 2x + \sin(3x), \quad y(0) = -1$
```

```{solution} laplace-transform-sb-3
:class: dropdown
\begin{align}
L[y' - y] &= L[1 - 2x + \sin 3x ] \\
