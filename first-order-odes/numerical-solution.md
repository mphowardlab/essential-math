...
```{exercise}
:label: first-order-odes-numerical-solution-sb-1
Solve $y' = y + 5 \sin(2\pi t)$ with $y(0) = 1$ using Euler's method with
...
```{solution} first-order-odes-numerical-solution-sb-1
:class: dropdown
