...
```{exercise}
:label: undetermined-coefficient-sb-1
...
```{solution} undetermined-coefficient-sb-1
:class: dropdown
...
```{exercise}
:label: undetermined-coefficient-sb-2
...
```{solution} undetermined-coefficient-sb-2
:class: dropdown
1. Find homogeneous solution $y_{\rm h}$:
...
```{exercise}
:label: undetermined-coefficient-sb-3
...
```{solution} undetermined-coefficient-sb-3
:class: dropdown
1. Find homogeneous solution $y_{\rm h}$:
